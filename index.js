...
function getPrice() {
  // CONTRACT FIX: restore the `price` field name and explicitly declare units.
  // Pricing now returns cents (minor units), not dollars. The `unit` field allows
  // consumers to convert correctly.
