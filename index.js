...
function getPrice() {
  // CONTRACT FIX: Restored field name to `price` (was incorrectly renamed to `amount`).
  // Values are in cents (permanent migration). Unit is declared explicitly for consumers.
